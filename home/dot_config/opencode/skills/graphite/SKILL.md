---
name: graphite
description: Manage stacked branches and commits using the Graphite CLI (gt) — create, navigate, restack, and maintain stacks
---
...
| Command | Action |
| :--- | :--- |
| `gt create <branch-name>` | Create a new branch with the given name and stack it on top of the current one. |

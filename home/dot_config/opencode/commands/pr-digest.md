...
**Fan out one subagent per group** (use the Task tool with `subagent_type: "general"`). For very large groups (>10 PRs or >5K total lines changed), split into multiple subagents.
